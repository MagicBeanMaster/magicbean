...
/*
      $table.delegate('.footable-row-detail','mousedown',function(e){
          if ($table.is('.breakpoint') && $(this).prev('tr').hasClass('footable-detail-show')) {
              var pageX=e.pageX,pageY=e.pageY;
              $table.delegate('.footable-row-detail','mouseup',function(e){
                 if( (!Math.abs(e.pageX-pageX) > 0 || !Math.abs(e.pageY-pageY)>0) && e.which==1 ){
    ...
    ft.getViewportWidth = function() {
    	return window.parent.innerWidth || (document.body ? document.body.offsetWidth : 0);
      //return window.innerWidth || (document.body ? document.body.offsetWidth : 0); //error:iframe
    };
